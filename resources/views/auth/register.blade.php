                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('address_id') ? ' has-error' : '' }}">
                            <label for="name" class="col-md-4 control-label">Address_id</label>

                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="address_id" value="{{ old('address_id') }}">
                        ...
                        <div class="form-group{{ $errors->has('picture') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="picture" value="{{ old('picture') }}">
                        ...
                        <div class="form-group{{ $errors->has('store_id') ? ' has-error' : '' }}">
                            <label for="name" class="col-md-4 control-label">Store_id</label>

                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="store_id" value="{{ old('store_id') }}">
                        ...
                        <div class="form-group{{ $errors->has('active') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="active" value="{{ old('active') }}">
